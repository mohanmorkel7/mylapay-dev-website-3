...
const FlowingDesign = () => {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden  p-4 text-center">
      {/* Background Lines */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center mt-16">
        ...
        <h2 className="mb-8 text-xl font-bold primarycolormylapay md:text-3xl">
           Modular, Plug-in Product Set for Acquiring Support
        </h2>
