...
import HeroVideo from "@/pages/videos/upipayments.mp4"
    ...
    return (
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          >
            Supercharge your UPI acquiring with a high-performance platform built for real-time switching, reconciliation, settlement, and dispute resolution.
          </Reveal>
