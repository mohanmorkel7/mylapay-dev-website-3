...
import HeroVideo from "@/pages/videos/paymentorchestration.mp4"
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          <Reveal
            ...
            duration={800}
            delay={0}
            className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-extrabold leading-tight drop-shadow-[0_6px_24px_rgba(0,0,0,0.55)]"
          >
          ...
          >
            Supercharge your payment acceptance with an intelligent orchestration hub
          </Reveal>
