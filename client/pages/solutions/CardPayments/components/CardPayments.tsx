...
import HeroVideo from "@/pages/videos/cardpayment.mp4"
    ...
    return (
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          >Power your acquiring program with a unified processing platform built on modernized payment infrastructure</Reveal>
