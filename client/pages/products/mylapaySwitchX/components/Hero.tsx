...
import HeroVideo from "@/pages/videos/switchx.mp4"
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          > Mylapay  
            ...
            <span className="text-[#2cade3]"> SwitchX </span>
            a dynamic Payment Orchestration Hub that puts the power of precision routing in your hands.
            {/* <p className="text-[#2cade3] mt-2 ">powered by Mylapay 3DSS</p> */}
          </Reveal>
          ...
          >
            Designed to unify and optimize your acquiring infrastructure across cards, UPI and NetBanking with built-in smart routing, switch-level controls, and real-time risk engines—bringing end-to-end payment solutions into one unified layer.
          </Reveal>
                    ...
                    >
                      {/* <a
                        href="https://apitest.mylapay.com/"
