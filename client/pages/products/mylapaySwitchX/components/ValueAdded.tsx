...
import { Waypoints, Landmark, Globe, CreditCard,} from "lucide-react";
import { useRef } from "react";
import CompanyLogo from "@/pages/assets/images/fav.png"
const features = [
  {
    title: "Switches",
    desc: "Mylapay C-Switch, U-Switch, CyberSource, MPGS",
    icon: <Waypoints className="w-8 h-8 text-white" />,
  },
  {
    title: "Bank’s Gateway",
    desc: "Connectivity to all major banks for direct payment processing",
    icon: <Landmark className="w-8 h-8 text-white" />,
  },
  {
    title: "Net-Banking",
    desc: "Seamless payments via NPCI’s net-banking infrastructure",
    icon: <Globe className="w-8 h-8 text-white" />,
  },
  {
    title: "Card Networks",
    desc: "Visa, Mastercard, RuPay (via VAP/MIP EAS connectivity)",
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between gap-12">
        {/* Left-side content */}
          ...
          >
            ...
            >
              SwitchX is a unified gateway 
              <br />
              that connects you to multiple gateways of your choice.
            </motion.h2>
          </motion.div>
        </div>
