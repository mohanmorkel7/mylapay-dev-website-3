...
import HeroVideo from "@/pages/videos/uswitch.mp4"
    ...
    return (
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          > Mylapay
            <span className="text-[#2cade3]"> U-Switch Power </span>
            Smarter UPI payments with Mylapay - Blazing fast, Ultra-reliable, and Secure
            <p className="text-[#2cade3] mt-2 ">Certified By NPCI</p>
          </Reveal>
          ...
          >
            Purpose-built for PA-PGs and banks, U-Switch manages Pay and Collect flows with intelligence and speed. It simplifies routing, automates reconciliation cycles, and handles adjustments and chargebacks in real time.
          </Reveal>
