...
import HeroVideo from "@/pages/videos/intellepro.mp4"
    ...
    return (
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          > Mylapay
            <span className="text-[#2cade3]"> IntellePro </span>
            {/* <br /> */}
            A real-time transaction processing system, purpose built to power high-volume UPI payment operation with speed and accuracy
            {/* <p className="text-[#2cade3] mt-2 ">powered by Mylapay IntellePro </p> */}
          </Reveal>
          ...
          >
           Built for UPI at scale, desinged to auto reconcile, manage settlements between NPCI and PSPs and handle refunds and chargebacks with precision
          </Reveal>
