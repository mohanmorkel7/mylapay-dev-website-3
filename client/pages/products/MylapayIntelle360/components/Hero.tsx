...
import HeroVideo from "@/pages/videos/intelle360.mp4"
    ...
    return (
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          > Mylapay 
            <span className="text-[#2cade3]"> Intelle360 </span>
            Delivering complete financial protection and drive profits for every payment you acquire.
            {/* <p className="text-[#2cade3] mt-2 "></p> */}
          </Reveal>
          ...
          >
            A cutting-edge analytical product built to optimize the acquiring card payments, delivering unmatched intelligence, control and visibility into the transaction lifecycle, revenue and profitability.
          </Reveal>
