...
import { TrendingUp, Globe, Loader, BarChart2 } from "lucide-react";
import { useRef } from "react";
import CompanyLogo from "@/pages/assets/images/fav.png"
const features = [
  {
    title: "Financial Reporting",
    desc: "Reconciles clearing files and incoming data at txn level, delivering accurate settlement, Jv, and Gl reports for accounting closure.",
    icon: <TrendingUp className="w-8 h-8 text-white" />,
  },
  {
    title: "FIRC for Cross-Border Payments  ",
    desc: "Capture network FX rates for accurate conversation and reconciliation, enabling FIRC generation.",
    icon: <Globe className="w-8 h-8 text-white" />,
  },
  {
    title: "More Than Reports - We delivery Results",
    desc: "We don't just surface data - we partner withyou to uncover profit opportunities and fight fee discrepancies with network on your behalf .",
    icon: <Loader className="w-8 h-8 text-white" />,
  },
  {
    title: "Hands-On Intelligence",
    desc: "Beyond analytics, we act - verifying charges, resolving mismatches, and defending your margins at every step",
            ...
            <div className="lg:sticky lg:top-20 lg:h-screen lg:flex-1 lg:flex lg:flex-col lg:justify-center text-white">
                    ...
                    >
                      ...
                      >
                        ...
                        <br />
                        We go the extra mile to ensure your acquiring payments are seamless and profitable
                      </motion.h2>
                    </motion.div>
            </div>
