...
import HeroVideo from "@/pages/videos/tokenx.mp4"
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          <Reveal
            ...
            duration={800}
            delay={0}
            className="text-xl sm:text-xl md:text-xl lg:text-2xl font-extrabold leading-tight drop-shadow-[0_6px_24px_rgba(0,0,0,0.55)] !leading-[1.1]"
          > Mylapay 
            <span className="text-[#2cade3]"> TokenX </span>
            Unified Card Tokenization Platform for All Networks <br />
          </Reveal>
            <h1 className="text-[#2cade3] mt-2 text-xl sm:text-xl md:text-xl lg:text-2xl font-extrabold"> COFT & Alt ID Complaint</h1>
          <Reveal
            as="p"
            variant="fadeUp"
            duration={800}
            delay={100}
            className="mt-6 max-w-2xl text-l md:text-l text-white/85"
          >
            Designed for banks and payment gateways, this solution enables customers to pay effortlessly using tokenized cards — fully compliant with RBI guidelines. Seamless payments lead to higher conversions and accelerated business growth.
          </Reveal>
