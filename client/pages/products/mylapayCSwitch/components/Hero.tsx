...
import HeroVideo from "@/pages/videos/cswitch.mp4"
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          <Reveal
            ...
            duration={800}
            delay={0}
            className="text-xl sm:text-xl md:text-2xl lg:text-2xl font-extrabold leading-tight drop-shadow-[0_6px_24px_rgba(0,0,0,0.55)] !leading-[1.1]"
          > Mylapay
            <span className="text-[#2cade3]"> C-Switch </span>
            Switch to smarter  speedier and safer payments with Mylapay CardSwitch, delivering high success rate.
            <p className="text-[#2cade3] mt-2 ">Certified by all leading global card networks.</p>
          </Reveal>
          ...
          >
            A fully compliant and certified Base I Auth switch, designed for banks and payment aggregators to acquire card payments in both card-present (POS) and card-not-present (e-commerce PG) scenarios.
          </Reveal>
