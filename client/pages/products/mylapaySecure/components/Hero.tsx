...
import HeroVideo from "@/pages/videos/3dsecure.mp4"
    ...
    return (
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          > Mylapay
            <span className="text-[#2cade3]"> Secure </span>
            Zero friction authentication fraud mitigation, and lightning-fast payments
          ...
          >
            Acquiring Banks and Payment aggregators can confidently accept card payments — free from fraud and chargeback worries.
          </Reveal>
