...
import { ClipboardPlus, BookKey, Globe, BarChart2 } from "lucide-react";
...
const features = [
  {
    ...
    icon: <ClipboardPlus className="w-8 h-8 text-white" />,
  },
  {
    title: "Transaction Cost Insights",
    desc: "Provides detailed cost visibility by capturing interchange and scheme fees at the transaction level.",
    icon: <BookKey className="w-8 h-8 text-white" />,
  },
  {
    title: "Cross-Border Payments",
    desc: "Captures network FX rates for accurate conversion and reconciliation, enabling FIRC generation.",
    icon: <Globe className="w-8 h-8 text-white" />,
  },
  {
    title: "Dashboard Insights",
    desc: "All financial reports, metrics, and summaries are unified in a single dashboard for complete operational visibility.",
        ...
        <div className="lg:sticky lg:top-20 lg:h-screen lg:flex-1 lg:flex lg:flex-col lg:justify-center text-white">
          ...
          >
            ...
            >
              ...
              <br />Our platform goes the extra mile to ensure your settlements are timely, accurate, and hassle-free.
            </motion.h2>
          </motion.div>
        </div>
