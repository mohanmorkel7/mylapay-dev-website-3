...
import HeroVideo from "@/pages/videos/intellesolve.mp4"
    ...
    return (
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          > Mylapay
            <span className="text-[#2cade3]"> IntelleSettle </span>
            Clearing & Settlement, Reimagined
            {/* <p className="text-[#2cade3] mt-2 ">Empower your payment aggregation with a real-time infrastructure built for speed and scale</p> */}
          </Reveal>
          <Reveal
            as="p"
            variant="fadeUp"
          ...
          >
            A fully compliant and certified Base II Clearing system built for banks and payment aggregators to accurately clear card payment transactions with networks and settles as per your schedule.
          </Reveal>
