...
import { TrendingUp, Radar, Loader, FileChartPie } from "lucide-react";
import { useRef } from "react";
import CompanyLogo from "../../../assets/images/fav.png"; // Replace with your actual logo path

const features = [
  {
    title: "Smart Rule Engine",
    desc: "Uses 500+ prebuilt logic sets to trigger intelligent dispute responses.",
    icon: <TrendingUp className="w-8 h-8 text-white" />,
  },
  {
    title: "Merchant Communication ",
    desc: "Automated and streamlined document exchange and audit trails — no follow-ups needed.",
    icon: <Radar className="w-8 h-8 text-white" />,
  },
  {
    title: "Full Lifecycle Tracking",
    desc: "From retrieval to representment to arbitration — every case is tracked with precision.",
    icon: <Loader className="w-8 h-8 text-white" />,
  },
  {
    title: "Dashboard Insights",
    desc: "Real-time visibility into dispute types, age scheme, and next action -- with direct links to respond.",
    icon: <FileChartPie className="w-8 h-8 text-white" />,
  },
];
        ...
        <div className="lg:sticky lg:top-20 lg:h-screen lg:flex-1 lg:flex lg:flex-col lg:justify-center text-white">
          ...
          >
            ...
            >
              ...
              <br />
              With the right tools to help you manage disputes effortlessly
            </motion.h2>
          </motion.div>
        </div>
          ...
          {features.map((feature, idx) => {
            ...
            return (
              <motion.div
                ...
                className="relative bg-white rounded-3xl p-8 flex flex-col items-center text-center shadow-md w-full mb-12 cursor-default"
