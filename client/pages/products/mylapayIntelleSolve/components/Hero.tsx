...
import HeroVideo from "@/pages/videos/solve.mp4"
    ...
    return (
      ...
      >
        ...
        <div className="w-full max-w-5xl pl-6 md:pl-12 lg:pl-20">
          ...
          > Mylapay
            <span className="text-[#2cade3]"> IntelleSolve </span>
            Resolve and recover chargebackss effectively with a fully automated dispute management platform built for accuracy, compliance, and speed.
            {/* <p className="text-[#2cade3] mt-2 ">powered by Mylapay IntelleSolve</p> */}
          </Reveal>
          ...
          >Designed for banks, acquirers, and payment aggregators. It streamlines workflows for all categories of disputes—from the initial chargeback to arbitration—and ensures recovery
          </Reveal>
