...
import { TrendingUp, ToggleLeft, BookLock, LayoutDashboard } from "lucide-react";
import { useRef } from "react";
import CompanyLogo from "@/pages/assets/images/fav.png"

const features = [
  {
    title: "Real-Time Txn Monitoring",
    desc: "Track transaction flags, hold/release triggers, and multi-tier risk outcomes — all in real time.",
    icon: <TrendingUp className="w-8 h-8 text-white" />,
  },
  {
    title: "Kill Switch Controls",
    desc: "Instantly block transactions by merchant, MCC, card type, or BIN — based on real-time threat detection.",
    icon: <ToggleLeft className="w-8 h-8 text-white" />,
  },
  {
    title: "Comprehensive Risk Reports",
    desc: "Access transaction flag, daily anomaly reports, and settlement insights for continue us risk visibility.",
    icon: <BookLock className="w-8 h-8 text-white" />,
  },
  {
    title:"Intuitive Dashboard",
    desc: "Gain deeper operational visibility and merchant-level risk insights for smarter decisions and compliance.",
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between gap-12">
                ...
                <div className="lg:sticky lg:top-20 lg:h-screen lg:flex-1 lg:flex lg:flex-col lg:justify-center text-white">
                  ...
                  >
                    ...
                    >
                     We’ve built the tools <br/>so you can manage smarter,
                      <br />
